    ...
    <section id="how-it-works" className="relative py-24 bg-white">
      <div className="section-container">
        ...
        <div className="relative">
          {/* Connection line */}
          <div className="absolute left-1/2 top-8 bottom-0 w-0.5 bg-mocktagon-100 hidden md:block" />
          ...
          <div className="space-y-12 md:space-y-0 md:grid md:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="flex flex-col md:items-end text-right process-animate animate-on-scroll">
              <div className="md:order-1 mb-4 md:mb-0">
                <div className="relative flex items-center justify-center">
                  <div className="md:absolute md:right-[-50px] h-16 w-16 rounded-full bg-mocktagon-100 flex items-center justify-center z-10">
                    <UserPlus className="h-8 w-8 text-mocktagon-700" />
                  </div>
                  <div className="hidden md:block md:ml-8 w-8 h-0.5 bg-mocktagon-100" />
                </div>
              </div>
              <div className="glass-card p-6 rounded-xl md:mr-12">
                <h3 className="heading-md mb-2 text-mocktagon-900">Create Your Profile</h3>
            ...
            <div className="flex flex-col md:items-start text-left md:mt-32 process-animate animate-on-scroll" style={{ transitionDelay: '0.1s' }}>
              <div className="mb-4 md:mb-0">
                <div className="relative flex items-center justify-center">
                  <div className="md:absolute md:left-[-50px] h-16 w-16 rounded-full bg-mocktagon-100 flex items-center justify-center z-10">
                    <BrainCircuit className="h-8 w-8 text-mocktagon-700" />
                  </div>
                  <div className="hidden md:block md:mr-8 w-8 h-0.5 bg-mocktagon-100" />
                </div>
              </div>
              <div className="glass-card p-6 rounded-xl md:ml-12">
                <h3 className="heading-md mb-2 text-mocktagon-900">Select Interview Type</h3>
                <p className="text-gray-600">
            ...
            <div className="flex flex-col md:items-end text-right process-animate animate-on-scroll" style={{ transitionDelay: '0.2s' }}>
              <div className="md:order-1 mb-4 md:mb-0">
                <div className="relative flex items-center justify-center">
                  <div className="md:absolute md:right-[-50px] h-16 w-16 rounded-full bg-mocktagon-100 flex items-center justify-center z-10">
                    <MessageSquare className="h-8 w-8 text-mocktagon-700" />
                  </div>
                  <div className="hidden md:block md:ml-8 w-8 h-0.5 bg-mocktagon-100" />
                </div>
              </div>
              <div className="glass-card p-6 rounded-xl md:mr-12">
                <h3 className="heading-md mb-2 text-mocktagon-900">Practice with AI</h3>
                <p className="text-gray-600">
            ...
            <div className="flex flex-col md:items-start text-left md:mt-32 process-animate animate-on-scroll" style={{ transitionDelay: '0.3s' }}>
              <div className="mb-4 md:mb-0">
                <div className="relative flex items-center justify-center">
                  <div className="md:absolute md:left-[-50px] h-16 w-16 rounded-full bg-mocktagon-100 flex items-center justify-center z-10">
                    <BarChart className="h-8 w-8 text-mocktagon-700" />
                  </div>
                  <div className="hidden md:block md:mr-8 w-8 h-0.5 bg-mocktagon-100" />
                </div>
              </div>
              <div className="glass-card p-6 rounded-xl md:ml-12">
                <h3 className="heading-md mb-2 text-mocktagon-900">Review & Improve</h3>
                <p className="text-gray-600">
